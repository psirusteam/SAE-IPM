...
rownames(data_2)<- paste0("P",1:N)
tba(data_2, "Iteración (l=2)")
```
...
rownames(data_3)<- paste0("P",1:N)
tba(data_3, "Iteración (l=3)")
```
...
rownames(data_4)<- paste0("P",1:N)
tba(data_4, "Iteración (l=4)")
```
...
rownames(data_5)<- paste0("P",1:N)
tba(data_5, "Iteración (l=5)")
```
